                        ...
                        <div class="sb-slick-slider" data-slick-setting='{
                            ...
                            @foreach($slides as $slide)
                             <div class="single-slide bg-image bg-overlay--dark"
                                data-bg="{{ asset($slide->image_path)}}">
                                <div class="home-content text-center">
                                    <div class="row justify-content-end">
                                        <div class="col-lg-8">
                                            <h1 class="v2">{{$slide->title}}</h1>
                                            <h2>{{$slide->head}}</h2>
                                            <a href="{{route('client.shop.detail', 'slug')}}" class="btn btn--yellow">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-card card-style-list">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="{{route('client.shop.detail', 'slug')}}">Get Through To Your
                                                            BOOK</a></h3>
                                                </div>
                                        ...
                                        <div class="product-card card-style-list">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="{{route('client.shop.detail', 'slug')}}">What Can You Do To Save Your
                                                            BOOK</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                        ...
                                        <div class="product-card card-style-list">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="{{route('client.shop.detail', 'slug')}}">From Destruction By Social
                                                            Media?</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                        ...
                                        <div class="product-card card-style-list">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="{{route('client.shop.detail', 'slug')}}">Find Out More About BOOK ?</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                                    <del class="price-old">£51.20</del>
                                        ...
                                        <div class="product-card card-style-list">
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    ...
                                                    <h3><a href="{{route('client.shop.detail', 'slug')}}">Controversial BOOK
                                                            Social Media?</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{route('client.shop.detail', 'slug')}}">Lightweight
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{route('client.shop.detail', 'slug')}}">Ways To Have More
                                                                BOOK</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                            ...
                                            <div class="product-card--body">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{route('client.shop.detail', 'slug')}}">10 Minutes, I'll Give You
                                                                The Truth</a></h3>
                                                </div>
                                                <div class="price-block">
                                                    <span class="price">£51.20</span>
                                                    ...
                                                    <div class="product-card">
                                                        <div class="product-header">
                                                            <a href="" class="author">
                                                                ...
                                                                <h3><a href="{{route('client.shop.detail', 'slug')}}">{{$image->title}}</a></h3>
                                                        </div>
                                                        <div class="product-card--body">
                                                            <div class="card-image">
                                                                <img src="{{ asset($image->img)}}" alt="">
